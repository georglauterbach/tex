...
\ifacronymsOptionIsLoaded%
	...
	\newDualLangAcronym{mosfet}{MOSFET}{Metal-Oxide-Semiconductor Field-Effect Transistor}{Metall-Oxid-Halbleiter-Feldeffekttransistor}
	...
	\newDualLangAcronym{sloc}{SLOC}{Source Line of Code}{Quellcodezeile}
	\newDualLangAcronym{smp}{SMP}{Symmetric (sometimes also shared-memory) Multiprocessing}{Symmetrisches Multiprozessorsystem}
	\newDualLangAcronym{soc}{SoC}{System-on-a-Chip}{Ein-Chip-System}
...
\else
	...
	{%
		name={UNIX},
		description={\textit{UNIX} ist ein Mehrbenutzer-Betriebssystem (OS) für Computer. Es wurde im August $1969$ von \textit{Bell Laboratories} zur Unterstützung der Softwareentwicklung entwickelt. Heute steht \textit{UNIX} allgemein für Betriebssysteme, die entweder ihren Ursprung im Unix-System von \textit{AT\&T} (ursprünglich Bell Laboratories) haben oder dessen Konzepte implementieren. Es ist zusammen mit seinen Varianten und Weiterentwicklungen eines der verbreitetsten und einflussreichsten Betriebssysteme der Computergeschichte.}
	}
